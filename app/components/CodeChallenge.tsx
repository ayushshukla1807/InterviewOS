    ...
    <div className="flex flex-col h-full bg-[#0a0a0c] border-l border-gray-800">
      <div className="p-6 bg-[#111113] border-b border-gray-800">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-sm font-bold text-indigo-400 uppercase tracking-wider">Live Coding Challenge</h2>
          <select 
            value={lang} 
            onChange={(e) => setLang(e.target.value)}
            className="bg-[#1a1a1c] border border-gray-700 text-gray-300 text-sm rounded-lg px-3 py-1.5 focus:outline-none focus:border-indigo-500"
          >
